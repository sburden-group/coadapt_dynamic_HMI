...
rcParams['axes.titlesize'] = TINY_SIZE
rcParams['axes.labelsize'] = TINY_SIZE
rcParams['xtick.labelsize'] = TINY_SIZE
rcParams['ytick.labelsize'] = TINY_SIZE
rcParams['font.weight'] = 'ultralight'
rcParams['font.family'] = 'sans-serif'
# rcParams['mathtext.fontset'] = 'dejavusans'
rcParams['mathtext.fontset'] = 'cm'
rcParams['axes.linewidth'] = 0.5
rcParams['xtick.major.width'] = 0.5 # Set default major tick width for axis 
